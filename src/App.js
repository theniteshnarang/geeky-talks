...
const VideosList = lazy(
    () =>
        import(
            './features/videos/VideosList' /* webpackChunkName: "videos-list" */
        )
)
const VideoSingle = lazy(
    () =>
        import(
            './features/videos/VideoSingle' /* webpackChunkName: "video-single" */
        )
)
const Like = lazy(
    () => import('./features/like/Like' /* webpackChunkName: "like" */)
)
const Save = lazy(
    () => import('./features/save/Save' /* webpackChunkName: "save" */)
)
const Login = lazy(
    () => import('./features/auth/LoginForm' /* webpackChunkName: "login" */)
)
const SignUp = lazy(
    () => import('./features/auth/SignUpForm' /* webpackChunkName: "sign-up" */)
)
